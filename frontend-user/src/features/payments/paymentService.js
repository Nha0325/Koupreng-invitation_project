...
export const paymentService = {
    ...
    paymentOrder: (orderCode) => api.get(`/v1/me/payments/${encodeURIComponent(orderCode)}`).then(unwrap),
    paymentReceipt: (orderCode) => api.get(`/v1/me/payments/${encodeURIComponent(orderCode)}/receipt`).then(unwrap),
};
