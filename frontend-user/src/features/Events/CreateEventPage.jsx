...
/* ── Session card ── */
const SessionCard = ({ session, index, onChange, onDelete, canDelete }) => {
  const addSubItem = () => {
    onChange({
      ...session,
  ...
  const updateSubItem = (i, field, val) => {
    const updated = session.subItems.map((s, idx) =>
      idx === i ? { ...s, [field]: val } : s,
    );
  ...
  const deleteSubItem = (i) => {
    onChange({
      ...session,
      subItems: session.subItems.filter((_, idx) => idx !== i),
    });
  };
    ...
    <div className="ce-session-card">
      ...
      <div className="ce-field" style={{ marginBottom: "10px" }}>
        <label className="ce-label">
          លោះអវ្យបរាះ <span className="req">*</span>
        </label>
        <input
          type="text"
          className="ce-input"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const eventData = {
        ...
        location: form.venue,
        description:
          form.groom && form.bride ? `${form.groom} & ${form.bride}` : "",
        image: imagePreview,
      };
    ...
    <div className="ce-page">
      <div className="ce-body">
        ...
        <p className="ce-section-sub">
          គ្រប់បំពេញភាពទៅតាមកម្មវិធី (Link Preview)
        </p>
        ...
        <form id="ce-form" onSubmit={handleSubmit}>
          <div className="ce-grid">
            ...
            <div className="ce-field">
              <label className="ce-label">
                ប្រើប្រាស់ប្រភេទកម្មវិធី <span className="req">*</span>
              </label>
              <select
                className="ce-select"
                value={form.type}
            ...
            <div className="ce-field">
              <label className="ce-label">
                ចូនប្រុសនាម <span className="req">*</span>
              </label>
              <input
                type="text"
                className="ce-input"
            ...
            <div className="ce-field">
              <label className="ce-label">
                ចូនស្រីនាម <span className="req">*</span>
              </label>
              <input
                type="text"
                className="ce-input"
            ...
            <div className="ce-field">
              <label className="ce-label">
                កាលបរិច្ឆេទចាប់ផ្តើមកម្មវិធី <span className="req">*</span>
              </label>
              <input
                type="date"
                className="ce-input"
            ...
            <div className="ce-field">
              <label className="ce-label">
                ម៉ោងចាប់ផ្តើមនៃការចាប់ <span className="req">*</span>
              </label>
              <TimePicker
                value={form.time}
          ...
          <div className="ce-sessions">
            ...
            >
              <div className="ce-sessions-header-left">
                ...
                អវ្យបរាះកម្មវិធី
                <span className="ce-sessions-count">
                  {sessions.length} អវ្យបរាះ
                </span>
              </div>
              <svg
                width="16"
