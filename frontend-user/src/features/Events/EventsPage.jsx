  ...
  return (
    <div className="events-topbar">
      <div className="events-topbar-brand">
        <span className="events-topbar-logo">
          <span>💒</span> Koupreang
        </span>
  ...
  return (
    <div className="events-sidebar">
      {icons.map((path, i) => (
        <div
          key={i}
          className={`events-sidebar-icon${i === 0 ? " active" : ""}`}
        >
          <svg
            width="18"
            height="18"
...
/* ── Event card ── */
const EventCard = ({ event, onManage }) => {
  return (
    <div className="event-card" onClick={() => onManage(event)}>
      ...
      <div className="event-card-body">
        ...
        <div className="event-card-desc">
          {event.description || "ពិធីមង្គលការ"}
        </div>
...
const EventsPage = () => {
  ...
  if (view === "create") {
    return <CreateEventPage onBack={() => setView("list")} />;
  }
        ...
        <div className="events-content">
          ...
          >
            <div className="events-welcome">
              <h1>សូមស្វាគមន៍!</h1>
              <p>
                សូមគ្រប់គ្រងព្រឹត្តិការណ៍របស់អ្នក បង្កើតថ្មី ដើម្បីចាប់ផ្តើម។
              </p>
            </div>
            <button
          ...
          {events.length === 0 ? (
            <div className="events-empty">
              ...
              <p>
                អ្នកមិនទាន់បង្កើតកម្មវិធីណាមួយនៅឡើយ។
                ចាប់ផ្តើមបង្កើតកម្មវិធីដំបូងរបស់អ្នក!
              </p>
              <button
                className="events-create-btn"
                onClick={() => setView("create")}
