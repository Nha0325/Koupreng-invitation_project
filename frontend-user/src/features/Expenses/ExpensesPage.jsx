...
import AddExpenseModal from "../../shared/components/modals/AddExpenseModal";
...
const ExpensesPage = () => {
  ...
  const handleAddExpense = (newExpense) => {
    const expenseWithId = {
      ...
      budget: Number(newExpense.budget),
    };
  ...
  return (
    <div className="ep-page">
      ...
      <div className="ep-header">
        ...
        <button className="ep-add-btn" onClick={() => setIsAddModalOpen(true)}>
          + បន្ថែមការចំណាយ
        </button>
      </div>
      ...
      <div className="ep-budget-card">
        <div className="ep-budget-row">
          <div className="ep-budget-item">
            ...
            <span className="ep-budget-value">
              ${totalBudget.toLocaleString()}
            </span>
          </div>
          <div className="ep-budget-item">
            <span className="ep-budget-label">បានចំណាយ</span>
            <span className="ep-budget-value spent">
              ${totalSpent.toLocaleString()}
            </span>
          </div>
          <div className="ep-budget-item">
            <span className="ep-budget-label">នៅសល់</span>
            <span className="ep-budget-value remaining">
          ...
          <tbody>
            {filtered.map((e) => (
              <tr key={e.id}>
                ...
                <td>
                  <span className="ep-cat-badge">{e.category}</span>
                </td>
                ...
                <td>
                  <span
                    className={`ep-status ${e.status === "paid" ? "ep-paid" : "ep-pending"}`}
                  >
                    {e.status === "paid" ? "បានបង់" : "រង់ចាំ"}
                  </span>
                </td>
                <td>
                  <button className="ep-action-btn">⋯</button>
                </td>
              </tr>
            ))}
          </tbody>
