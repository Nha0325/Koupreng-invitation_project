 ...
 * MarketingShell
 *
 * Public chrome for the marketing / auth routes (`/`, `/login`, `/register`,
 * `/forgot-password`, `/reset-password`, and the `*` 404). Per the design's
 * Routing Map and "Component Architecture" section, marketing pages get the
 * site `<Header />` only — no authenticated `<Aside />` — and the matched
 * child route is rendered through react-router's `<Outlet />`, wrapped in
