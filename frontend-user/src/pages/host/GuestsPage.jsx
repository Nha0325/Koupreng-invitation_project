  ...
  return (
    <div className="inv-page">
      <header className="inv-page-header">
        <div>
          <span className="inv-eyebrow">Guests</span>
          <h1>បញ្ជីភ្ញៀវ</h1>
          <p>ជ្រើសរើសកម្មវិធីមួយ ដើម្បីបើកបញ្ជីភ្ញៀវដែលភ្ជាប់ទៅ backend។</p>
        </div>
      ...
      {!loading && !invitations.length && (
        <div className="inv-empty">
          <p>មិនទាន់មានកម្មវិធីសម្រាប់គ្រប់គ្រងភ្ញៀវទេ។</p>
          ...
          {invitations.map((invitation) => (
            <article className="inv-card" key={invitation.id}>
              ...
              <div className="inv-card-actions">
                <Link className="inv-primary-btn" to={`/dashboard/invitations/${invitation.id}/guests`}>
                  គ្រប់គ្រងភ្ញៀវ
                </Link>
