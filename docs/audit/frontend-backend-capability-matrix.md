...
| **User Profile / Password** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/profile`, `/dashboard/change-password` | `userApi.js` | `GET /api/users/me`, `PATCH /api/users/me`, `POST /api/users/me/profile-image` | `UserService`, `AccountService` | `AppUser` (`users`) |
| **Events Management** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/events` (`EventsPage.jsx`) | `eventApi.js` | `GET /api/v1/events`, `POST /api/v1/events`, `DELETE /api/v1/events/{id}` | `EventService` | `Event` (`events`) |
...
| **Guest Management** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/guests`, `/dashboard/invitations/:id/guests` | `guestApi.js` | `GET /api/v1/invitations/{id}/guests`, `POST /api/v1/invitations/{id}/guests`, `POST /api/v1/invitations/{id}/guests/import` | `GuestService` | `Guest` (`guests`) |
| **RSVP Submissions & Wishes** | `IMPLEMENTED_AND_CONNECTED` | `/i/:slug`, `/dashboard/invitations/:id/rsvp` | `rsvpApi.js` | `POST /api/v1/public/invitations/{slug}/rsvp`, `GET /api/v1/invitations/{id}/rsvps` | `RsvpService` | `Rsvp` (`rsvps`) |
...
| **Budget & Expense Tracker** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/invitations/:id/budget`, `/dashboard/expenses` | `budgetApi.js` | `GET /api/v1/invitations/{id}/budget`, `POST /api/v1/invitations/{id}/budget/items` | `BudgetService` | `Budget`, `BudgetItem` |
| **Wedding Gift Tracker** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/gifts` | `planningApi.js` | `GET /api/v1/invitations/{id}/gifts`, `POST /api/v1/invitations/{id}/gifts` | `WeddingGiftService` | `WeddingGift` (`wedding_gifts`) |
| **Subscription Packages** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/packages` | `subscriptionApi.js` | `GET /api/v1/packages`, `GET /api/v1/me/subscriptions`, `POST /api/v1/me/subscriptions/purchase` | `SubscriptionService` | `SubscriptionPackage`, `Subscription` |
...
| **Organizations / Team Accounts** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/organizations`, `/dashboard/organizations/:organizationId` | `organizationApi.js` | `GET /api/v1/organizations`, `POST /api/v1/organizations`, `POST /api/v1/organizations/{id}/members` | `OrganizationService` | `Organization`, `OrganizationMember` |
| **AI Invitation Assistant** | `IMPLEMENTED_AND_CONNECTED` | `/dashboard/invitations/:id/assistant` (`AiAssistantPage.jsx`) | `aiAssistantApi.js` | `POST /api/v1/ai/invitation-copy`, `POST /api/v1/ai/invitation/story`, `POST /api/v1/ai/invitation/translate` | `AiInvitationAssistantService` | None (Stateless) |
