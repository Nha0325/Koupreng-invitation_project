...
| **Organizations / Team Accounts** | `IMPLEMENTED_FRONTEND_INCOMPLETE` | Missing (`/dashboard/organizations`, `/dashboard/organizations/:id`) | `organizationApi.js` (UI screens missing) | `GET /api/v1/organizations`, `POST /api/v1/organizations`, `POST /api/v1/organizations/{id}/members` | `OrganizationService` | `Organization`, `OrganizationMember` |
