...
const EXPECTED_PATHS = [
  ...
  "/dashboard/invitations/:invitationId/guests", "/dashboard/invitations/:invitationId/rsvp", "/dashboard/invitations/:id/delivery",
  "/dashboard/invitations/:id/media", "/dashboard/invitations/:invitationId/budget",
  "/dashboard/invitations/:invitationId/check-in", "/dashboard/invitations/:invitationId/seating",
  "/dashboard/guests", "/dashboard/expenses", "/dashboard/gifts",
  "/dashboard/templates/paid", "/dashboard/profile", "/dashboard/change-password",
  "/dashboard/notifications", "/dashboard/organizations",
  "/dashboard/organizations/:organizationId", "/dashboard/packages", "/dashboard/payments",
