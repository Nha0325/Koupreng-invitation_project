...
import { listRsvps } from "../../../features/rsvp/api/rsvpApi";
...
const panelClass = "dash-panel rounded-[1.25rem] border border-stone-200/70 bg-white/90 p-5 shadow-[0_14px_45px_rgba(92,64,32,0.07)] ring-1 ring-white/80 backdrop-blur-xl";
...
function HeroPanel({ data, source, lang }) {
  ...
  return (
    <motion.section className="dash-panel relative overflow-hidden rounded-[1.75rem] border border-amber-100/80 bg-[linear-gradient(135deg,#fffaf0_0%,#ffffff_52%,#ecfdf8_100%)] p-5 shadow-[0_18px_60px_rgba(92,64,32,0.10)] ring-1 ring-white/80 backdrop-blur-xl md:p-6" variants={riseMotion}>
