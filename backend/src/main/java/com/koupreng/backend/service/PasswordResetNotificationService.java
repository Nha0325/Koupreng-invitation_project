...
public class PasswordResetNotificationService {
    ...
    public void sendResetLink(AppUser user, String token, Instant expiresAt) {
        ...
        if (mailSender == null) {
            ...
            throw new ApiException(HttpStatus.SERVICE_UNAVAILABLE, "Password reset email is not configured");
        }
        ...
        try {
            ...
            throw new ApiException(HttpStatus.SERVICE_UNAVAILABLE, "Password reset email could not be sent");
        }
    }
